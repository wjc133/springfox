...
import static springfox.documentation.spring.web.readers.operation.HandlerMethodResolver.useType
...
class HandlerMethodReturnTypesSpec extends Specification {
    ...
    static
    def ListOfMapOfStringOfStringType = resolver.resolve(List.class, resolver.resolve(Map.class, String.class, String.class))
